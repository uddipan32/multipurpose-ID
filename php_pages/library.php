<?php
session_start();
$_SESSION['path']="Location:/SID/php_pages/add_book.php";
...
$sql0="SELECT college FROM login WHERE name='$name'";
$result0=mysqli_query($con,$sql0);
$row0=mysqli_fetch_assoc($result0);
$_SESSION['clg_name']=$row0['college'];
...
<td>
<div class="menu_box">
<a href="add_student_to_library.php"><img src="/SID/png icon/new-user.png" width="100%">Add student</a>
</div>
</td>
<td>
<div class="menu_box">
<a href="barcode_reader.php"><img src="/SID/png icon/barcode.png" width="100%" >Barcode Scan</a>
</div>
</td>
<td>
<div class="menu_box">
<a href="find_stu_library.php"><img src="/SID/png icon/zoom-tool.png" width="100%" >Student Details</a>
</div>
</td>
<tr>
<td>
<div class="menu_box">
<a href="bookrec.php"><img src="/SID/png icon/book.png" width="100%" >Book records</a>
</td>
</table>
